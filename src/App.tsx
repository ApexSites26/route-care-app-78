...
import CompanyDocuments from "./pages/manager/CompanyDocuments";
        ...
        <AuthProvider>
          <BrandingProvider>
            <Routes>
              ...
              <Route path="/manager/documents" element={<ProtectedRoute allowedRoles={['manager']}><CompanyDocuments /></ProtectedRoute>} />
